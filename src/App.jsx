...
import ScrollToTopButton from './components/UI/ScrollToTopButton'; // Importar o novo botão
...
const MainLayout = ({ isAuthModalOpen, setIsAuthModalOpen }) => (
  <>
    ...
    <ScrollToTopButton /> {/* Adicionar o botão aqui */}
  </>
);
    ...
    <AuthProvider>
      <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        <Routes>
          ...
          {/* Rota genérica/splat por último */}
